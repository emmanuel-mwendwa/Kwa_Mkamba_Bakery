...
from . import auth
from .. import db
from .forms import SignUpForm, LogInForm, ChangePasswordForm, ChangeEmailForm, PasswordResetForm, PasswordResetRequestForm
from ..models import User
from ..email import send_email


# user signup route sending confirmation token
...
# confirming users through the token
...
# run commands before the app starts
# confirm whether the user is confirmed
...
# if user is unconfirmed redirect user
